                    ...
                    <div class="lg:pl-12 md:pl-16 lg:hidden sm:block justify-center place-content-center">
                                ...
                                {/* <div class="grid gap-0 sm:gap-4 grid-cols-1 sm:grid-cols-2 justify-center place-items-center">
                                    ...
                                    <div class="sm:block flex-col pl-4 justify-center">
                                        ...
                                        <div class="flex-1">
                                            <p class="flex mb-2 text-gray-600 px-4">
                                                <span class="inline"> Unit 102 - 3001 SF </span> <span class="inline"> &nbsp; - Offer </span>
                                            </p>                                 
                                        </div>
                    ...
                    <div class="lg:pl-12 md:pl-16 lg:hidden sm:block justify-center place-content-center">
                                ...
                                {/* <div class="grid gap-0 sm:gap-4 grid-cols-1 sm:grid-cols-2 justify-center place-items-center">
                                    ...
                                    <div class="sm:block flex-col pl-4 sm:pl-0 sm:pr-4 place-items-center">
                                        ...
                                        <div class="flex-1">
                                            <p class="flex mb-2 text-gray-600 px-4">
                                                <span class="inline line-through"> Unit 106 - 1565 SF </span> <span class="inline"> &nbsp;- Leased </span>
                                            </p>
                ...
                <section class="text-gray-700 justify-center sm:justify-start pt-4 ">
                    <div class="lg:pl-12 md:pl-16 lg:hidden sm:block justify-center place-content-center">
                                ...
                                {/* <div class="grid gap-0 sm:gap-4 grid-cols-1 sm:grid-cols-2 justify-center place-items-center">
                                    ...
                                    <div class="flex-1">
                                        <p class="flex mb-2 text-gray-600 px-4">
                                            <span class="inline"> Unit 108 - 682 SF </span> <span class="inline"> &nbsp;- Offer</span>
                                        </p>
                                    </div>
                                    ...
                                    <div class="flex-1">
                                        <p class="flex mb-2 text-gray-600 px-4">
                                            <span class="inline "> Unit 112 - 1270 SF </span> <span class="inline"> &nbsp; </span>
                                        </p>
                                    </div>

                                    <div class="flex-1">
                                        <p class="flex mb-2 text-gray-600 px-4">
                                            <span class="inline "> Unit 113 - 926 SF </span> <span class="inline"> &nbsp; </span>
                                        </p>
                                    </div>
                    ...
                    <div class="lg:pl-12 md:pl-16 lg:hidden sm:block justify-center place-content-center">
                                ...
                                {/* <div class="grid gap-0 sm:gap-4 grid-cols-1 sm:grid-cols-2 justify-center place-items-center">
                                    ...
                                    <div class="sm:block flex-col pl-14 sm:pl-0 sm:pr-4 place-items-center">
                                        ...
                                        <div class="flex-1">
                                            <p class="flex mb-2 text-gray-600 px-4">
                                                <span class="inline "> Unit 208 - 797 SF </span> <span class="inline"> - Offer </span>
                                            </p>
                                        </div>
                    ...
                    <div class="lg:pl-12 md:pl-16 lg:hidden sm:block justify-center place-content-center">
                                ...
                                {/* <div class="grid gap-0 sm:gap-4 grid-cols-1 sm:grid-cols-2 justify-center place-items-center">
                                    ...
                                    <div class="sm:block flex-col pl-16 sm:pl-0 sm:pr-4 place-items-center">
                                        ...
                                        <div class="flex-1">
                                            <p class="flex mb-2 text-gray-600 px-4">
                                                <span class="inline "> Unit 308 - 613 SF </span> <span class="inline"> &nbsp; - Offer </span>
                                            </p>
                                        </div>
                                        ...
                                        <div class="flex-1">
                                            <p class="flex mb-2 text-gray-600 px-4">
                                                <span class="inline "> Unit 311 - 1389 SF </span> <span class="inline"> &nbsp;- Offer </span>
                                            </p>
                                        </div>
